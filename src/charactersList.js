const characters = [
    ...
    {//0
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/KeUpWYP.png", "https://i.imgur.com/6LQO17g.png", "https://i.imgur.com/fI76Xvx.png"],
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: "Creates a Reality Marble. (Slightly raises agility, raises magic stat,apply damage dealt based on magic.)",// agility & magic =+  (np.power + magic stat)/2 dmg based on magic
    ...
    {//2
        ...
        statsPoints: 0,
        passive: ["Mental Pollution","Grants immunity to confusion."],
        quotes: ["COOOOOL!"],
    ...
    {//3
        ...
        class: "Rider",
        pictures: ["https://i.imgur.com/9yZYTEU.jpg", "https://i.imgur.com/U6lfSDc.png", "https://i.imgur.com/DP4WAvs.png"],
        ...
        statsPoints: 0,
        passive: ["Mystic Eyes of Petrification", "Inflicts 3 turn stun to the enemy and reduces their agility by 25% at the beginning of battle."],
        ...
        noblePhantasm: {
            ...
            text: [""],
            image: "https://imgur.com/ZJCwK89.jpg",
            canBeUsed: false
        }
    },
    ...
    {//5
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/iioJpAP.jpg", "https://i.imgur.com/Fs0CcxX.png", "https://i.imgur.com/y0PPzbg.png"],
        ...
        statsPoints: 0,
        passive: ["Sabotage", "Reduces enemy Strength and Magic stats by 60% at the beginning of battle."],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/8NAlAGp.jpg", "https://i.imgur.com/GrTKZB9.png", "https://i.imgur.com/DOxUvR3.png"],
        alignment: ["Chaotic", "Neutral"],
        traits: ["male", "king"],
        ...
        statsPoints: 0,
        passive: ["Strategic Thinking", "Each turn reduce the highest stat of the enemy by 3%. When HP falls below 25% apply evade (2times) to self."],
...

    {
        ...
        class: "Rider",
        pictures: ["https://i.imgur.com/zx3JbZ6.png", "https://i.imgur.com/CpIgj2x.png", "https://i.imgur.com/zNMJPgr.png", "https://i.imgur.com/6c0TLrE.png", "https://i.imgur.com/jaoWKi9.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["male"],
        ...
        statsPoints: 0,
        passive: ["Geass Command", "When HP drops below 25%: each turn there is 50% chance that guts effect will be inflicted on self."],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/xhEDc8i.png", "https://i.imgur.com/C3ELi84.png", "https://i.imgur.com/qVJcSWU.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["female"],
...

    {
        ...
        statsPoints: 0,
        passive: ["Played Steel", "Copies passive skill of the enemy."],
...

    {
        ...
        statsPoints: 0,
        passive: ["Sadism", "Everytime you inflict normal attack damage to the enemy increase own strength by 15% of damage dealt."],
...

    {
        ...
        statsPoints: 0,
        passive: ["Rapid Words of Divine", "Charge gained each turn +1"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/cSYj6JB.jpg", "https://i.imgur.com/saWi3tl.png", "https://i.imgur.com/jyLbcz3.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["female"],
        ...
        statsPoints: 0,
        passive: ["Hawk Eye", "Applies sure hit to normal attacks."],
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: "Snipes enemy from the distance with high accuracy (Raises own critical strength and luck first, then deals def ignoring damage, sure hit.)",
            text: [],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/hWjewVo.jpg", "https://i.imgur.com/GJyGbYN.png", "https://i.imgur.com/fdUS5r6.png"],
        alignment: ["Neutral", "Good"],
        traits: ["male"],
...

    {
        ...
        statsPoints: 0,
        passive: ["Pure Heart", "Can not be poisoned nor confused"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/0iM74mE.jpg", "https://i.imgur.com/bjIEJis.png", "https://i.imgur.com/ZH7bj9e.png"],
        alignment: ["Lawful", "Good"],
        traits: ["female"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/j8b6NHs.jpg", "https://i.imgur.com/hXnUdKN.png", "https://i.imgur.com/DeTBbJp.png"],
        alignment: ["Neutral", "Good"],
        traits: ["male"],
...

    {
        ...
        class: "Lancer",
        pictures: ["https://i.imgur.com/HjzqOeL.jpg", "https://i.imgur.com/5XR39JX.png", "https://i.imgur.com/StzJPKA.png"],
        alignment: ["Neutral", "Good"],
        traits: ["male"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/onrWdpk.jpg", "https://i.imgur.com/ijaB2b2.png", "https://i.imgur.com/V16gLBb.png"],
        alignment: ["Neutral", "Good"],
...

    {
        ...
        statsPoints: 0,
        passive: ["Knoweledge of the Future", "If evade is active, Critical Strength +100%"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/A7enl1f.jpg", "https://i.imgur.com/9O0APLj.png", "https://i.imgur.com/SYDoXb0.png"],
        alignment: ["Lawful", "Good"],
        ...
        noblePhantasm: {
            name: "Excalibur",
            power: 50,
            description: "A Noble Phantasm that stands at the top of all holy swords (first slightly raises own magic then deals significant damage, inflicts NP Seal on self - 10 turns [demerit])",
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/qzBdYFU.jpg", "https://i.imgur.com/Dvy6XuQ.png", "https://i.imgur.com/LsXMzE0.png"],
        alignment: ["Chaotic", "Good"],
        traits: ["female", "king"],
        ...
        statsPoints: 0,
        passive: ["Invictus Spiritus", "Starts the battle with active guts status"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/wn1tbWB.png", "https://i.imgur.com/ulY4UFX.png", "https://i.imgur.com/WczgTWd.png"],
        alignment: ["Chaotic", "Good"],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/hEb56pK.png", "https://i.imgur.com/LYoEwQ1.png", "https://i.imgur.com/3Mj7j14.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["male", "divine"],
...

    {
        ...
        class: "Lancer",
        pictures: ["https://i.imgur.com/gUSKzyF.png", "https://i.imgur.com/Hb5RmEG.png", "https://i.imgur.com/3HkcY2e.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["male"],
        ...
        statsPoints: 0,
        passive: ["Love Spot", "If the enemy is female and is not a part of the 3 kight classes reduce their all stats by 20%"],
...

    {
        ...
        statsPoints: 0,
        passive: ["Presence Detection", "Starts batle with evade (1time); prevents opponent from applying evade status to themselves"],
...

    {
        ...
        statsPoints: 0,
        passive: ["Honor of Suffering", "Each time when receiving normal attack damage increase own Strength stat by 10% of damage dealt; reduce the cost of healing spells by 50%"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/WmDMpDt.png", "https://i.imgur.com/OStIlv1.png", "https://i.imgur.com/RJeNGY9.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["female", "dragon", "king"],
        ...
        statsPoints: 0,
        passive: ["Mana Burst", "Lowers damage taken by 30%"],
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: "The form Excalibur takes after being corrupted by evil. (first slightly raises own magic then deals significant damage, inflicts NP Seal on self - 10 turns [demerit])",
            text: ["Cry out. It is time to fall to the ground.",
                "Hammer of the Vile King. Overturn the aurora. Swallow the light!"
                ],
            image: "https://i.imgur.com/cihEz81.gif",
            canBeUsed: false
        }
    },

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/Fp8wCPS.png", "https://i.imgur.com/HeVUT3l.png", "https://i.imgur.com/PTs07Ka.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["female"],
        ...
        statsPoints: 0,
        passive: ["All Kinds of Specializations", "Raises all stats by 10% and apllies evasion to self (1time) at the start of battle."],
...

    {
        ...
        statsPoints: 0,
        passive: ["Clairvoyance", "Applies sure hit to normal attacks, + 5% to crit chance"],
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: "She can create an axis of rotation anywhere within sight and warps them telekinetically, which causes gruesome dismemberments and deaths. (deals damage, decreases enemy defense, slightly increases own luck, sure hit)",
            text: [""],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/8bvVqhU.png", "https://i.imgur.com/APWPzz3.png", "https://i.imgur.com/W11rP35.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["female", "divine"],
...

    {
        ...
        class: "Rider",
        pictures: ["https://i.imgur.com/QzwN98U.jpg", "https://i.imgur.com/iBH6gtN.png", "https://i.imgur.com/C7RxBX9.png"],
        alignment: ["Chaotic", "Evil"],
        traits: ["female"],
...

    {
        ...
        class: "Berserker",
        pictures: ["https://i.imgur.com/3Ajd4Mi.png", "https://i.imgur.com/LoEmohg.png", "https://i.imgur.com/dU0ICHr.png"],
        alignment: ["Chaotic", "Evil"],
        traits: ["female"],
    ...
    {
        id: 53,
        name: ["suzuka gozen", "tate eboshi", "jk saber"],
        class: "Saber",
        pictures: ["https://i.imgur.com/J0sK8e1.png", "https://i.imgur.com/qCK2CpS.png", "https://i.imgur.com/r5DWhYe.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["female", "divine"],
        ...
        statsPoints: 0,
        passive: ["Supernatural Power (JK)", "Critical chance +20%; Critical Strength +30%"],
...

    {
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: "The favored mount used by Rider. (increases Rider's agility, deals damage)",
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/ODkQgAJ.png", "https://i.imgur.com/XfJqivB.png", "https://i.imgur.com/9jojm6V.png", "https://i.imgur.com/8WZ21p3.png", "https://i.imgur.com/ahuv3AL.png"],
        alignment: ["Lawful", "Good"],
        traits: ["male"],
        ...
        statsPoints: 0,
        passive: ["Unstable Mind", "25% chance to gain +2 NP charge each turn; NP seal status immunity; confusion last 2 times longer and deals doube damage on self [demerit]"],
...

    {
        ...
        class: "Rider",
        pictures: ["https://i.imgur.com/TEjMiaT.png", "https://i.imgur.com/ek80Iq4.png", "https://i.imgur.com/dASVzev.png"],
        alignment: ["Neutral", "Good"],
...

    {
        ...
        statsPoints: 0,
        passive: ["The Queen's Glass Game", "Winds back the battle to the first turn upon its activation, meaning that the girls’ game will continue on forever if they are not defeated by a set turn (12 turns); starts battle with NP charge = 2"],
...

    {
        ...
        class: "Berserker",
        pictures: ["https://i.imgur.com/WB2k8YA.jpg", "https://i.imgur.com/mYQoZWw.png", "https://i.imgur.com/ABMClbX.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["female"],
...

    {
        ...
        class: "Shielder",
        pictures: ["https://i.imgur.com/yjlj2dP.png", "https://i.imgur.com/4tcsC4R.png", "https://i.imgur.com/tuA6ba0.png"],
        alignment: ["Lawful", "Good"],
        traits: ["female"],
        ...
        statsPoints: 0,
        passive: ["Masochism", "Each time when receiving normal attack damage increase own Strength stat by 20% of damage dealt"],
...

    {
        ...
        name: ["eugeo", "yujio"],
        class: "Saber",
        pictures: ["https://i.imgur.com/yveQbgA.jpg", "https://i.imgur.com/LMXYQ0D.png", "https://i.imgur.com/wmAAECl.png"],
        alignment: ["Neutral", "Good"],
        traits: ["male"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/9DXb1qK.jpg", "https://i.imgur.com/Rz8pbRY.png", "https://i.imgur.com/U3QFVAd.png"],
        alignment: ["Chaotic", "Good"],
    ...
    
    {
        ...
        statsPoints: 0,
        passive: ["Scorching Flames", "Adds inflict burn (2 turns) to normal attacks"],
...

    {
        ...
        class: "Foreigner",
        pictures: ["https://i.imgur.com/spZD3Th.jpg", "https://i.imgur.com/tWn4gsv.png", "https://i.imgur.com/6AkcUgI.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["male"],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/mIjf2MT.png", "https://i.imgur.com/u5cs8AH.png", "https://i.imgur.com/Nt4ErIP.png", "https://i.imgur.com/bda983X.png", "https://i.imgur.com/tQfv0hd.png"],
        alignment: ["Chaotic", "Neutral"],
        traits: ["male", "dragon"],
...

    {
        ...
        class: "Avenger",
        pictures: ["https://i.imgur.com/mHrQZyd.png", "https://i.imgur.com/NATcSzp.png", "https://i.imgur.com/P8xnF44.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["female"],
        ...
        statsPoints: 0,
        passive: ["Mechanical Body", "Immunity to poison, decreases damage taken by 10%"],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/dNWMvJH.jpg", "https://i.imgur.com/fPTwSLp.png", "https://i.imgur.com/moTyCwi.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["male"],
...

    {
        ...
        class: "Berserker",
        pictures: ["https://i.imgur.com/MRVoeQZ.png", "https://i.imgur.com/TTxi8CK.png", "https://i.imgur.com/an9oOou.png"],
        alignment: ["Chaotic", "Evil"],
        traits: ["male"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/BkCzQV0.png", "https://i.imgur.com/GVyiU7x.png", "https://i.imgur.com/Vka3IYm.png"],
        alignment: ["Lawful", "Good"],
        traits: ["female", "divine"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/UJ6MITZ.png", "https://i.imgur.com/Gpb4iLx.png", "https://i.imgur.com/M4v9UqQ.png"],
        alignment: ["Chaotic", "Good"],
        traits: ["male", "divine", "king"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/JX3oqRc.png", "https://i.imgur.com/1gGdlaJ.png", "https://i.imgur.com/mkiu7ov.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["male", "divine"],
    ...
    
    {
        ...
        class: "Ruler",
        pictures: ["https://i.imgur.com/2AIi64h.png", "https://i.imgur.com/pWdKyrF.png", "https://i.imgur.com/INJkKTI.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["divine"],
...

    {
        ...
        class: "Lancer",
        pictures: ["https://i.imgur.com/zlM3Df0.png", "https://i.imgur.com/6nCy1E0.png", "https://i.imgur.com/C3M3rr2.png"],
        alignment: ["Chaotic", "Neutral"],
        traits: ["female"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/arsugyQ.png", "https://i.imgur.com/7hZQBLs.png", "https://i.imgur.com/dxGJLk9.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["female"],
...

    {
        ...
        class: "Avenger",
        pictures: ["https://i.imgur.com/zDZqdDw.jpg", "https://i.imgur.com/ZNrdB1G.png", "https://i.imgur.com/RxVOhd1.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["male"],
...

    {
        ...
        class: "Moon Cancer",
        pictures: ["https://i.imgur.com/m5IzGDl.jpg", "https://i.imgur.com/O6apGod.png", "https://i.imgur.com/HT1Gt4k.png"],
        alignment: ["Chaotic", "Evil"],
        traits: ["female"],
        ...
        statsPoints: 0,
        passive: ["Self-awareness", "Immunity to confusion"],
...

    {
        ...
        class: "Ruler",
        pictures: ["https://i.imgur.com/Of73goz.png", "https://i.imgur.com/w3npLf0.png", "https://i.imgur.com/E45yw25.png"],
        alignment: ["Lawful", "Good"],
        traits: ["female"],
        ...
        statsPoints: 0,
        passive: ["Revelation", "At the start of the battle provides all informations about the enemy"],
        quotes: [""],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/ajURJhh.jpg", "https://i.imgur.com/y9pwVcc.png", "https://i.imgur.com/YmYCLZZ.png", "https://i.imgur.com/DHsl7Xb.png", "https://i.imgur.com/7peVbxl.png"],
        alignment: ["Neutral", "Good"],
        traits: ["male"],
...

    {
        ...
        class: "Alter Ego",
        pictures: ["https://i.imgur.com/5tDcEzl.png", "https://i.imgur.com/iY2FUKc.png", "https://i.imgur.com/ee23e7I.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["female", "divine"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/oybBD9K.png", "https://i.imgur.com/NBnIdBd.png", "https://i.imgur.com/X4OpVCQ.png", "https://i.imgur.com/4jnkdyM.png", "https://i.imgur.com/98xR2gp.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["male"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/PVbaBA3.png", "https://i.imgur.com/f8Bq4Yz.png", "https://i.imgur.com/Trg2kGe.png"],
        alignment: ["Chaotic", "Neutral"],
        traits: ["male"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/ywGhh9W.png", "https://i.imgur.com/SBI2NbW.png", "https://i.imgur.com/k1hf0kj.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["female"],
        ...
        noblePhantasm: {
            name: "Holopsicon",
            power: 50,
            description: "Described by Archer that it is omnipotent, Holopsicon's vast array of abilities is the direct result of Altair's having no story of her own. (raises own defence, decreases enemy magic, deals damage)",
            text: [""],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/gWKhpMl.png", "https://i.imgur.com/Rr1OMEc.png", "https://i.imgur.com/rZmLces.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["male"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/qqgz8J4.png", "https://i.imgur.com/k7zDavg.png", "https://i.imgur.com/tJerbi8.png"],
        alignment: ["Chaotic", "Evil"],
        traits: ["male"],
...

    {
        ...
        class: "Foreigner",
        pictures: ["https://i.imgur.com/1hEJC0S.png", "https://i.imgur.com/VdoKctg.png", "https://i.imgur.com/e7aTZQG.png"],
        alignment: ["Lawful", "Good"],
        traits: ["male"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/T2ED9sP.png", "https://i.imgur.com/tLSKZzB.png", "https://i.imgur.com/R1rcItD.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["female"],
...

    {
        ...
        class: "Rider",
        pictures: ["https://i.imgur.com/5lYpFj1.png", "https://i.imgur.com/fHg9HQP.png", "https://i.imgur.com/okVLZHm.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["male", "king"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/9jl3MQ4.png", "https://i.imgur.com/cj7IDKI.png", "https://i.imgur.com/mxI1w5i.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["female"],
...

    {
        ...
        class: "Lancer",
        pictures: ["https://i.imgur.com/VTO4LGD.png", "https://i.imgur.com/P6DMSuy.png", "https://i.imgur.com/ar8TmVs.png"],
        alignment: ["Chaotic", "Evil"],
        traits: ["female", "divine"],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/U2nrI3J.png", "https://i.imgur.com/0J3Baf9.png", "https://i.imgur.com/36CUaGV.png"],
        alignment: ["Chaotic", "Good"],
        traits: ["female", "divine"],
...

    {
        ...
        class: "Avenger",
        pictures: ["https://i.imgur.com/rQ4wBDT.png", "https://i.imgur.com/9ePXOcn.png", "https://i.imgur.com/q7rZByT.png"],
        alignment: ["Chaotic", "Evil"],
        traits: ["female", "divine"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/kktT9Ac.png", "https://i.imgur.com/k7xBbLP.png", "https://i.imgur.com/Zf52cwv.png"],
        alignment: ["Lawful", "Good"],
        traits: ["male"],
...

    {
        ...
        class: "Lancer",
        pictures: ["https://i.imgur.com/dupo1D5.png", "https://i.imgur.com/9KzFw2p.png", "https://i.imgur.com/docIOOD.png"],
        alignment: ["Neutral", "Good"],
        traits: ["female", "king"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/AgWRJMF.png", "https://i.imgur.com/mQ612QT.png", "https://i.imgur.com/Mdp7jQC.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["female"],
...

    {
        ...
        class: "Ruler",
        pictures: ["https://i.imgur.com/QvubaiC.png", "https://i.imgur.com/a03aJ69.png", "https://i.imgur.com/qWX7Ges.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["male", "king"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/nuWe3To.png", "https://i.imgur.com/o9D8vou.png", "https://i.imgur.com/lxtWAec.png"],
        alignment: ["Chaotic", "Neutral"],
        traits: ["female"],
    ...
    {
        id: 106,
        name: ["ainz ooal gown", "ainz", "supreme one", "lord momonga", "sorcerer king", "momon", "king of darkness"],
        class: "Caster",
        pictures: ["https://i.imgur.com/yH7Q65u.jpg", "https://i.imgur.com/GdFQaCx.png", "https://i.imgur.com/HDGaPPe.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["male", "king"],
...

    {
        ...
        class: "Avenger",
        pictures: ["https://i.imgur.com/tkLBvOL.png", "https://i.imgur.com/HlKp6m2.png", "https://i.imgur.com/X70yRRz.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["male"],
...

    {
        ...
        statsPoints: 0,
        passive: ["Regeneration", "Each turn restore own HP by 3%"],
...

    {
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: `Magecraft that materializes objects, in accordance to the caster’s imagination, through the use of magical energy. (drastically raises own strength) 2nd: **Avalon:** gives him an extremely potent regenerative ability (apllies guts status.)`,
            text: [
                "Trace... ON!"
            ],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/dIYrVcZ.png", "https://i.imgur.com/HbiOKMA.png", "https://i.imgur.com/qQwGGbP.png", "https://i.imgur.com/xRdeQyu.png", "https://i.imgur.com/U1FoiXD.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["female"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/Szv07f1.png", "https://i.imgur.com/RrJjYtj.png", "https://i.imgur.com/r1jIlEX.png"],
        alignment: ["Chaotic", "Good"],
        traits: ["female"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/orZgL65.png", "https://i.imgur.com/xlxSaZf.png", "https://i.imgur.com/AbTf3ev.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["female"],
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: `Archer unleashes an arrow of love that is sure to pierce the target's heart. Those who reject her love shall die. Because of her own shame for doing such a flashy thing, she is stunned for 2 turns. (sure hit, deals def-ignoring damage, insta kill chance - 5%, lowers enemy strength,  inflicts stun on self - 2 turns)`,
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/440KNoi.png", "https://i.imgur.com/2o8a9jM.png", "https://i.imgur.com/AQpkpi7.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["female"],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/5wFJpGy.png", "https://i.imgur.com/1dvozqK.png", "https://i.imgur.com/zU20OUH.png"],
        alignment: ["Chaotic", "Neutral"],
        traits: ["female"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/HPc9NGe.png", "https://i.imgur.com/PQKgZrM.png", "https://i.imgur.com/t5NC7ze.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["male"],
...

    {
        ...
        name: ["neopolitan", "neo"],
        class: "Lancer",
        pictures: ["https://i.imgur.com/3lefigM.png", "https://i.imgur.com/GNkLpr8.png", "https://i.imgur.com/yRCS2Tr.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["female"],
...

    {
        ...
        class: "Archer",
        pictures: ["https://i.imgur.com/BtEm2xt.png", "https://i.imgur.com/mZXu3YW.png", "https://i.imgur.com/C5cZZxT.png"],
        alignment: ["Lawful", "Good"],
...

    {
        ...
        class: "Lancer",
        pictures: ["https://i.imgur.com/NwpxTDw.png", "https://i.imgur.com/35SzE8z.png", "https://i.imgur.com/k4qbDOA.png"],
        alignment: ["Neutral", "Evil"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/QMd1XJ8.png", "https://i.imgur.com/Cco91R6.png", "https://i.imgur.com/gSnqWmZ.png"],
        alignment: ["Neutral", "Good"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/HxKcZtt.png", "https://i.imgur.com/T1MvCUA.png", "https://i.imgur.com/7SzvTRs.png"],
        alignment: ["Lawful", "Neutral"],
        traits: ["female", "summer"],
...

    {
        ...
        class: "Caster",
        pictures: ["https://i.imgur.com/caReUzv.png", "https://i.imgur.com/bGgKZYB.png", "https://i.imgur.com/Py8532u.png"],
        alignment: ["Neutral", "Good"],
        traits: ["male"],
...

    {
        ...
        class: "Saber",
        pictures: ["https://i.imgur.com/epfoN5u.png", "https://i.imgur.com/RmEnux6.png", "https://i.imgur.com/b6vkkyC.png"],
        alignment: ["Chaotic", "Good"],
        traits: ["female"],
...

    {
        ...
        class: "Moon Cancer",
        pictures: ["https://i.imgur.com/FWuRli5.png", "https://i.imgur.com/44qftM3.png", "https://i.imgur.com/ofS27Df.png"],
        alignment: ["Neutral", "Neutral"],
        traits: ["male"],
        about: `A sharp tongued man from a world very similar to this one, but, in his words, "without any sort of magic, hope, or good luck". According to himself, he's just a regular friendless high schooler. Digging into the history embedded in his saint graph it appears he was part of a "Service Club" which helped others "Grant their Wishes".`,
        level: 1,
        exp: 0,
        currentHp: 250,
        maxHp: 250,
...

    {
        ...
        statsPoints: 0,
        passive: ["", ""],
        quotes: ["What are you doing Master?!\nWhat are you, stupid?!"],
        summonableWith: '<:icons8wheel:644265939441025024> ⚙ 🔋',
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/O5a44VO.png", "https://i.imgur.com/Wp2gDBJ.png", "https://i.imgur.com/cba8bsP.png"],
        alignment: ["Lawful", "Evil"],
        traits: ["female"],
...

    {
        ...
        class: "Berserker",
        pictures: ["https://i.imgur.com/vdQjJCH.png", "https://i.imgur.com/CvMbsqY.png", "https://i.imgur.com/zcr0ADn.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["female"],
...

    {
        ...
        class: "Assassin",
        pictures: ["https://i.imgur.com/5Ic4SJs.png", "https://i.imgur.com/I6IIxtW.png", "https://i.imgur.com/H4SDtxa.png"],
        alignment: ["Chaotic", "Good"],
...

    {
        ...
        class: "Berserker",
        pictures: ["https://i.imgur.com/K6tAEuo.png", "https://i.imgur.com/GJTxLw6.png", "https://i.imgur.com/nP8EKcV.png"],
        alignment: ["Neutral", "Evil"],
        traits: ["female", "king", "dragon"],
...

    {
        ...
        class: "Shielder",
        pictures: ["https://i.imgur.com/SggW5Va.jpg", "https://i.imgur.com/OwvnLLz.png", "https://i.imgur.com/2rts1yh.png", "https://i.imgur.com/OwvnLLz.png", "https://i.imgur.com/2rts1yh.png"],
        alignment: ["Chaotic", "Good"],
...

    {
        ...
        noblePhantasm: {
            name: "Arsene",
            power: 50,
            description: `Joker invokes and calls upon Arsene, using his Persona's powers to change the tides of battle to his favor. (Deals damage (if enemy magic stat is greater use theirs magic stat value to calculate the damage dealt), lower enemy agility and apply curse - 10 turns, lose 10% own hp [demerit], if assassin is cursed: remove curse and decrease enemy HP by 20%)`,
    ...
    {
        id: 152,
        name: ["takuru miyashiro", "takuru", "miyashiro takuru", "miyashiro", "taku", "president of the hekiho academy newspaper club", "right-sider"],
        class: "Moon Cancer",
        ...
        noblePhantasm: {
            ...
            power: 50,
            description: `As a Gigalomaniac he can force certain concepts into existence through real-booting his delusions, he specializes in telekinesis that alows him to move objects with power of mind alone. His delusions can be unpleasant to him at times. (raise own magic and defense, calculate normal damage based on magic, apply fear to self - 4 turns[demerit])`,
...

    {
        ...
        noblePhantasm: {
            name: "Killer Queen",
            power: 50,
            description: `Killer Queen is a short-range humanoid Stand of average to above-average speed and melee attacking power. Killer Queen's powers revolve around setting up different kinds of bombs that can annihilate enemies in one blast. Revealing Assasin's True Name may activate "Bites The Dust"(raise own strength and agility, deals damage, insta kill chance 3%; if Assassin's True Name was revealed: damage raises to significant, insta kill chance raises to 30%, additionally drastically raises own luck )`,
